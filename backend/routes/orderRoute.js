...
import { placeOrder, verifyOrder, usersOrder, listOrders, updateStatus, deliverFeeCalculator } from "../controllers/orderController.js"


const orderRouter = express.Router();

orderRouter.post("/place",authMiddleware,placeOrder);
orderRouter.post("/deliverfeecalculator",authMiddleware,deliverFeeCalculator);
